...
export async function getServerSideProps() {
  ...
  return {
    props: { blogs }, // Pass the blogs data as props to the component
  };
}
          ...
          <div className="space-y-6">
            <div className="rounded-lg">
              <Card className="font-bold px-4 py-6 text-xl lg:w-[85%] text-gray-800 mb-2">
                <h1 className="mb-5">Newly Published Articles</h1>
                <ul>
                  <li className="py-3">
                    <div>
                      ...
                      <h2 className="text-gray-500 text-sm py-2 font-medium">
                        Written by: Vishv Salvi
                        <span className="inline-block mx-2 font-bold opacity-50 ml-0">·</span>
                        85 reads 5 comments
                      </h2>
                    </div>
                  </li>
                  <li className="py-3">
                    <div>
                      ...
                      <h2 className="text-gray-600 text-sm py-1 font-medium">
                        Written by: Vishv Salvi . 30 likes
                      </h2>
                    </div>
                  </li>
                </ul>
              ...
              <Card className="px-4 py-6 text-xl lg:w-[85%] mb-1 text-gray-700 bg-slate-50 text-center">
                <h1 className="mb-5 font-medium">Connect with me</h1>
